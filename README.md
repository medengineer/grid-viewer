...
![grid-viewer-screenshot](Resources/grid-viewer.png)

Visualizes the signal from an electrode array in a 2D layout. 

**Note:** This plugin is still in the prototype stage, and is not ready for widespread use.
...
Example 4096-channel data for File Reader available here: https://www.dropbox.com/s/b76frfsbv0amgcl/grid-viewer-example-data.zip?dl=0
